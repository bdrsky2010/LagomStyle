...
# 주요기능
- 상품 검색 및 필터링
  - 사용자가 원하는 상품을 빠르고 간편하게 찾을 수 있도록 다양한 상품을 검색할 수 있으며, 가격이나 날짜 기준으로 정렬할 수 있는 기능을 제공합니다.
- 상품 상세 정보 확인
...
# 주요기술
- 상품 검색 및 데이터 로딩 최적화
  - Naver 검색 API를 통해 상품 정보를 받아오며, 스크롤 시 안정적으로 데이터가 로딩될 수 있도록 Offset Based Pagination을 적용했습니다. 
- 상품 상세화면
  - WKWebView를 통해 외부 웹 페이지를 연동하여, 사용자가 앱 내에서 상품 세부 정보를 자연스럽게 확인할 수 있도록 구현했습니다.
- 장바구니
  - RealmSwift를 활용하여 Local DB를 설계하여 장바구니 데이터를 저장하고 관리하며, 폴더별로 상품을 분류할 수 있도록 하여 효율적인 필터링이 가능하도록 구현했습니다.
<br>
